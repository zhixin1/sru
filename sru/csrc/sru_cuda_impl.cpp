...
TORCH_LIBRARY(sru_cuda, m) {
    m.def("sru_forward_simple", &sru_forward_simple);
    m.def("sru_backward_simple", &sru_backward_simple); 
    m.def("sru_bi_forward_simple", &sru_bi_forward_simple);
    m.def("sru_bi_backward_simple", &sru_bi_backward_simple);
    m.def("sru_forward", &sru_forward);
    m.def("sru_backward", &sru_backward);
    m.def("sru_bi_forward", &sru_bi_forward); 
    m.def("sru_bi_backward", &sru_bi_backward);
}
